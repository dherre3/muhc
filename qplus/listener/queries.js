...
{
  return "INSERT INTO `PatientDeviceIdentifier`(`PatientDeviceIdentifierSerNum`, `PatientSerNum`, `DeviceId`, `RegistrationId`, `DeviceType`,`SessionId`, `LastUpdated`) VALUES (NULL, ?,?,?,?,?, NULL) ON DUPLICATE KEY UPDATE RegistrationId = ?, SessionId = ?, PatientSerNum = ?";
};
